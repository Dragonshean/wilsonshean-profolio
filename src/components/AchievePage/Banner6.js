...
import exhibit2023Img2 from "./img/intex2023-2.jpg";
import exhibit2023Img3 from "./img/intex2023-3.jpg";
import exhibit2023Img4 from "./img/intex2023-4.jpg";
...
export const Banner6 = () => {
  ...
  const [image, setImage] = useState(exhibit2023Img); //現在顯示的圖片是甚麼
